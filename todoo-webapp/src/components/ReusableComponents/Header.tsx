      ...
      <nav>
        <ul>
          <li
            ...
            onClick={() => handleNavigation('/kategorije')}
          >
            Kategorije
          </li>
          <li
            className={style.navItem}
            onClick={() => handleNavigation('/cenovnik')}
          >
            Cenovnik
          </li>
          <li
          ...
          <li
            ...
            onClick={() =>
              user
                ...
                : handleNavigation('/prijavi-se')
            }
          >
            {user ? 'Profil' : 'Prijavi se'}
          </li>
          <li className={style.optli}>
            <div
              className={style.navItem + ' ' + style.opt}
